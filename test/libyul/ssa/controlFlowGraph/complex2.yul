...
// Block1_1Exit [label="{ If v2 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
// Block1_1Exit:0 -> Block1_4 [style="solid"];
// Block1_1Exit:1 -> Block1_2 [style="solid"];
// Block1_2 [label="\
// Block 2; (2, max 17)\nLiveIn: phi1[2], v1[1], v0[1]\l\
// LiveOut: phi1[1], v1[1], v3[3], v0[1]\l\nUsed: phi1[1]\l\nv3 := mload(phi1)\l\
// v4 := eq(0x00, v3)\l\
// "];
// Block1_2 -> Block1_2Exit;
// Block1_2Exit [label="{ If v4 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
...
// Block1_7 [label="\
// Block 7; (5, max 17)\nLiveIn: phi1[1], v1[1], v3[3], v0[1]\l\
// LiveOut: phi1[1], v1[1], v3[2], v0[1]\l\nUsed: v3[1]\l\nv5 := eq(0x01, v3)\l\
// "];
// Block1_7 -> Block1_7Exit;
// Block1_7Exit [label="{ If v5 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
...
// Block1_10 [label="\
// Block 10; (7, max 17)\nLiveIn: phi1[1], v1[1], v3[2], v0[1]\l\
// LiveOut: phi1[1], v1[1], v3[1], v0[1]\l\nUsed: v3[1]\l\nv6 := eq(0x02, v3)\l\
// "];
// Block1_10 -> Block1_10Exit;
// Block1_10Exit [label="{ If v6 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
...
// Block1_13 [label="\
// Block 13; (9, max 17)\nLiveIn: phi1[1], v1[1], v3[1], v0[1]\l\
// LiveOut: phi1[1], v1[1], v0[1]\l\nUsed: v3[1]\l\nv7 := eq(0x03, v3)\l\
// "];
// Block1_13 -> Block1_13Exit;
// Block1_13Exit [label="{ If v7 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
...
// Block1_16Exit [label="{ If v8 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
...
// Block1_3 [label="\
// Block 3; (12, max 14)\nLiveIn: phi1[1], v1[1], v0[1]\l\
// LiveOut: v9[1], v1[1], v0[1]\l\nUsed: phi1[1]\l\nv9 := add(0x01, phi1)\l\
// v10 := calldataload(v9)\l\
// "];
// Block1_3 -> Block1_3Exit;
// Block1_3Exit [label="{ If v10 | { <0> Zero | <1> NonZero }}" shape=Mrecord];
